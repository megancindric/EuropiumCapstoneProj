...
namespace WalkaboutProj
{
    public static partial class APIKeys
    {
        public static readonly string APIURL = "https://maps.googleapis.com/maps/api/js?key=AIzaSyDWabab5TRKBTfCGXR7kiztxG2jqP6PNrs&callback=initMap";
